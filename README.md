...
| 📄 **Product Brief** | [Read `influence_finder_product_brief.pdf`](brief/influencer_finder_product_brief.pdf) |
...
3. **Read `APPROACH.md`** — methodology, decision frameworks, and what the first 30 days would look like
